...
def calculate_normalized_risk(medical_history):
    ...
    min_score = 0       # Since the minimum score is always ®
    # Normalize the total risk score
    normalized_risk_score = (total_risk_score - min_score)/(max_score - min_score)
    return normalized_risk_score


def preprocess_input(input_dict):     # These are same as X_train in original pandas dataframe columns
    expected_columns = ['age','number_of_dependants','income_lakhs','insurance_plan','genetical_risk',
                        ...
                        'marital_status_Unmarried','bmi_category_Obesity','bmi_category_Overweight','bmi_category_Underweight','smoking_status_Occasional',
